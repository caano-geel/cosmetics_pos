            ...
            <table class="table-striped table table-bordered" id="list">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right"><?php echo format_price($row['price']) ?></td>
                        <td class="text-right"><?php echo format_price($row['price'] * $row['quantity']) ?></td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
                <tfoot>
                    <tr>
                        ...
                        <th class="text-right"><?php echo format_price($amount) ?></th>
                    </tr>
                </tfoot>
            </table>
        </div>
